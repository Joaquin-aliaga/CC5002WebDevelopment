...
$query = "SELECT M.id, M.nombre, M.experiencia, C.nombre as comuna, twitter, M.email, M.celular 
...
if ($result->num_rows > 0){
	...
	echo "<table class=table><tbody><tr><th></th><th>Nombre Médico</th><th>Comuna</th><th>Datos Contacto</th></tr>\n";
