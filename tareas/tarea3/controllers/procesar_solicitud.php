...
if($_FILES){
    ...
    $filename = $nombre_solicitante . "_" . $_FILES['archivos-solicitante']['name'][0];
    $filetype = $_FILES['archivos-solicitante']['type'];
    $uploadfile = $uploaddir.basename($filename);
    if (!move_uploaded_file($_FILES['archivos-solicitante']['tmp_name'][0], $uploadfile)) {
...
$ruta_index = "../index.php?exito_solicitud=1";
