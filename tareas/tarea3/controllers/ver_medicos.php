...
<label for="busqueda" class="text-field">Busque al médico</label>
<input type="text" name="busqueda" id="busqueda" value="" onkeyup="buscar();" maxlength="30" autocomplete="off" placeholder="Nombre médico" />
</form>
